...
@section('title')@parent - {{ trans('backend_ar.create_form') }} @stop
@section('content-header')
<h1>
    {{ trans('backend_ar.properties') }}
</h1>
@stop
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form class="form-inputs" id="project-form" action="{{ route('properties.store') }}" data-parsley-validate="true" method="post">
